...
$emailUser = htmlspecialchars($_SESSION["emailUser"]);
   ...
   if ($err)
   {
        ...
        $arrayL = json_decode($responseLT, true);
         foreach ($arrayL as $key => $value) {
            ...
            if(!empty($arrayL))
            {
                $result ="Error tarea asociada a un requerimiento por favor dirijace al modulo de requerimientos para darle fin";
                ...
                if ($err) {
                    ...
                    /************* INICIO ENVIO CORREO CUANDO SE FINALIZA LA TAREA *********************************/
                    $contenido='
                                <table>                                       
                                    <tr>
                                        <td>'.$nameHomework.'</td>
                    ...
                    /*** CONSULTO LA API DE USUARIOS EXCEL Y OBTENER LOS CORREOS DE LOS ADMINISTRADORES DEL APLICATIVO***/
                                    ...
                                    /**********************************************CORREO*******************************************************/
                                        ...
                                        $correo->Subject = "Se da fin a la tarea ";
                ...
                } // fin else si no hay erro al actualizar la tarea
            }   //fin valida si exite un inicio de tarea
            else {
                $result = "Inicie primero la tarea";
                echo json_encode($result);
            }
    } //valido que la respuesta de la api de linea de tiempos sea nula
}//fin else curl linea de tiempo