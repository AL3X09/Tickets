...
$nStatus = $_REQUEST["nEstado"];
$IdResponsable=$_REQUEST["IdResponsable"];
//TODO validar si el estado llega vacio haga
$FechaInicioDesarrollo=$_REQUEST['FechaInicioDesarrollo'];
if ($FechaInicioDesarrollo!=null or $FechaInicioDesarrollo!=" Sin iniciar") {
    $startDevelopmentDate = $FechaInicioDesarrollo;
} else {
    $startDevelopmentDate = ($idStatus==7 ) ? $startDevelopmentDate = date("Y-m-d H:i:s") : null ;                //valido si el estado es en desarrollo actualizo la fecha si no la envio null
}

//si no llega vacio o " Sin iniciar" deje la fecha con la que se encuentra
...
$emailUserRadica= $_REQUEST["EmailRadica"];            //correo responsable del requerimiento
...
//    echo $response;
   if (is_numeric($response)) {
         ...
         //VALIDO QUE EL ESTADO DEL REQUERIMIENTO SEA FINALIZADO 
         if ($idStatus==6) {
            ...
            */
                ...
                $contenido='
                        <table>                    
                            <tr>
                            <td>Cambio de estado del ticket #'.$ticket.'</td>
                            </tr>
                            <tr>
                            <td>Cambia a estado '.$nStatus.'</td>
                            </tr>                    
                        </table>
                            ';
                    /*** CONSULTO LA API DE USUARIOS EXCEL Y OBTENER LOS CORREOS DE LOS ADMINISTRADORES DEL APLICATIVO***/
                            ...
                            /**********************************************CORREO*******************************************************/
                                ...
                                for ($i=0; $i <$contUsers ; $i++) { 
                                    ...
                                    $correo->AddAddress($emailsTo.$emailUserRadica);
                            
                                //Ponemos el asunto del mensaje
                                $correo->Subject = "Se finaliza requerimiento #".$ticket."";
                ...
                */
            ...
            } //FIN VALIDO ESTADO DEL REQUERIMIENTO EN FINALIZADO
                    ...
                    */
                    ...
                    $paramRequest = "{"
                            . "\r\n  \"IdRequerimiento\": $idRequirement,"
                            . "\r\n  \"IdTipoLineaTiempo\": 3,"
                            . "\r\n  \"Descripcion\": \"El requerimiento #$ticket Cambia a estado $nStatus\","
                            . "\r\n  \"EmailTo\": \"$emailsTo\","
                            . "\r\n  \"Tarea\": false,"
                            . "\r\n  \"IdTarea\": null,"
