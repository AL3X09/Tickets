...
$idRadicatorUser = (isset($_REQUEST['IdUsuarioRadica']) && !is_null($_REQUEST['IdUsuarioRadica']) && !empty($_REQUEST['IdUsuarioRadica'])) ? $_REQUEST['IdUsuarioRadica'] : "null";
...
$idApp = (isset($_REQUEST['IdAplicativo']) && !is_null($_REQUEST['IdAplicativo']) && !empty($_REQUEST['IdAplicativo'])) ? $_REQUEST['IdAplicativo'] : "null";
$idModule = (isset($_REQUEST['IdModulo']) && !is_null($_REQUEST['IdModulo'])) ? $_REQUEST['IdModulo'] : "null";
$idPriority = (isset($_REQUEST['IdPrioridad']) && !is_null($_REQUEST['IdPrioridad']) && !empty($_REQUEST['IdPrioridad'])) ? $_REQUEST['IdPrioridad'] : "null";
$idResponsable = (isset($_REQUEST['IdUsuarioResponsable']) && !is_null($_REQUEST['IdUsuarioResponsable']) && !empty($_REQUEST['IdUsuarioResponsable'])) ? $_REQUEST['IdUsuarioResponsable'] : "null";
