...
<html>
    ...
    <body>
        ...
        <table id="dg" title="Roles" class="easyui-datagrid" style="width:100%;height:250px"
               url="php/getRol.php"
               toolbar="#toolbar" pagination="true"
               rownumbers="true" fitColumns="true" singleSelect="true">
            <thead>
                <tr>
                    <th field="IdRol" width="50">#</th>
        ...
        <div id="dlg" class="easyui-dialog" style="width:400px;height:280px;padding:10px 20px"
            ...
            <div class="ftitle">Gestion de roles</div>
        ...
        <script type="text/javascript">
            ...
            function editUser() {
                ...
                if (row) {
                    ...
                    $('#fm').form('load', row);
                    url = 'php/updateRol.php?id=' + row.IdRol;
                }
            }
            function saveUser() {
                $('#fm').form('submit', {
