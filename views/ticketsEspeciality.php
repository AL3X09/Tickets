...
<html>
    <head>
        <meta charset="UTF-8">
        <title>MODULO CONTROL ESPECIALIDADES</title>
    ...
    <body>
        ...
        <div id="toolbar">
            <a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-add" plain="true" onclick="newUser()">Nueva Especialida</a>
